...
local Char6 = {
	name = 'Char6',
	card_img = Assets.CHAR6.CARD,
	is_card_loading = false,
	img = Assets.CHAR6.INITIAL,
	speed = 2,
	cooldown = 10,
...
-- LOAD
local walking = Assets.CHAR6.WALKING
...
local attack = Assets.CHAR6.ATTACK
...
local shoot_animation = Assets.CHAR6.SHOOT
------

Char6.animate.update = function(dt)
	return Char6.actions[Char6.current_action].update(dt)
end

Char6.animate.draw = function(x, y, ...)
	Char6.lifebar(x,y)
	Char6.show_name(x,y)
	return Char6.actions[Char6.current_action].draw(x,y)
end
