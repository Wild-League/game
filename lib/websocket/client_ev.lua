...
local tools = require'lib.websocket.tools'
local frame = require'lib.websocket.frame'
local handshake = require'lib.websocket.handshake'
...
local ev = function(ws)
  ...
  self.connect = function(_,url,ws_protocol)
    ...
    async_send,send_io_stop = require'lib.websocket.ev_common'.async_send(sock,loop)
        ...
        async_send(
          ...
          function()
            ...
            local read_upgrade = function(loop,read_io)
              ...
              message_io = require'lib.websocket.ev_common'.message_io(
                sock,loop,
                on_message,
              handle_socket_err)
